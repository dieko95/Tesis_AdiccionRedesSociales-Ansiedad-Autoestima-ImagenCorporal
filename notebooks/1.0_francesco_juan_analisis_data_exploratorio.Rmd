...
ggbetweenstats(
  ...
  outlier.tagging  = TRUE,
  type = "nonparametric", # cambiar a "parametric" si supuestos se cumplen.
  title = "Obesión de las Redes Sociales Según el Trabajo Actual" # Titulo con variables.
)
...
ggbetweenstats(
  ...
  outlier.tagging  = TRUE,
  type = "nonparametric", # cambiar a "parametric" si supuestos se cumplen.
  title = "Falta de control de las Redes Sociales Según el Trabajo Actual" # Titulo con variables.
)
...
ggbetweenstats(
  ...
  outlier.tagging  = TRUE,
  type = "nonparametric", # cambiar a "parametric" si supuestos se cumplen.
  title = "Uso excesivo de las redes sociales Según el Trabajo Actual" # Titulo con variables.
)
```
...
run_quantitative_bivariate_test(
  ...
  title = "Relación entre Puntaje Total Constructo Adicción a las Redes Sociales y Factor Área Interpersonal"
)
```

#Adicción a las Redes Sociales vs área corporal/personal
...
run_quantitative_bivariate_test <-
  function(x_vector,
    ...
    cor_test_result <-
      cor.test(original_df$adiccion_rrss,
               original_df$area_personal_corporal,
               method = method)
    ...
    original_df %>%
      ggplot(aes(x = area_personal_corporal, y = adiccion_rrss)) +
      geom_point() +
      labs(x = x_label, y = y_label, title =
             title)
...
run_quantitative_bivariate_test(
  ...
  y_label = "Puntaje Total Constructo Adicción a las Redes Sociales",
  title = "Relación entre Constructo Adicción a las Redes Sociales y Factor Área Coporal/Personal"
)
...
run_quantitative_bivariate_test <-
  function(x_vector,
    ...
    cor_test_result <-
      cor.test(original_df$adiccion_rrss,
               original_df$insatisfaccion_imagen_corp,
               method = method)
    ...
    original_df %>%
      ggplot(aes(x = insatisfaccion_imagen_corp, y = adiccion_rrss)) +
      geom_point() +
      labs(x = x_label, y = y_label, title =
             title)
...
run_quantitative_bivariate_test(
  ...
  y_vector = original_df$adiccion_rrss,
  x_label = "Puntaje BSQ Factor Insatisfacción en la imagen corporal",
  y_label = "Puntaje Total Constructo Adicción a las Redes Sociales",
  title = "Relación entre Constructo Adicción a las Redes Sociales y Factor Insatisfacción de la imagen corporal"
)

```

#Adicción a las Redes Sociales vs Factor preocupación por el peso y conductas asociadas
...
run_quantitative_bivariate_test <-
  function(x_vector,
    ...
    cor_test_result <-
      cor.test(original_df$adiccion_rrss,
               original_df$preocupacion_peso_conductas_asociadas,
               method = method)
    ...
    original_df %>%
      ggplot(aes(x = preocupacion_peso_conductas_asociadas, y = adiccion_rrss)) +
      geom_point() +
      labs(x = x_label, y = y_label, title =
             title)
...
run_quantitative_bivariate_test(
  ...
  y_vector = original_df$adiccion_rrss,
  x_label = "Puntaje BSQ Factor Preocupación por el peso y conductas asociadas",
  y_label = "Puntaje Total Constructo Adicción a las Redes Sociales",
  title = "Relación entre Constructo Adicción a las Redes Sociales y Factor Preocupación por el peso y coductas asociadas"
)


```

#Adicción a las Redes Sociales vs Factores Antiestéticos y emocionales
...
run_quantitative_bivariate_test <-
  function(x_vector,
    ...
    cor_test_result <-
      cor.test(original_df$adiccion_rrss,
               original_df$factores_antiesteticos_emociones,
               method = method)
    ...
    original_df %>%
      ggplot(aes(x = factores_antiesteticos_emociones, y = adiccion_rrss)) +
      geom_point() +
      labs(x = x_label, y = y_label, title =
             title)
...
run_quantitative_bivariate_test(
  ...
  y_vector = original_df$adiccion_rrss,
  x_label = "Puntaje BSQ Factores Antiestéticos y emocionales",
  y_label = "Puntaje Total Constructo Adicción a las Redes Sociales",
  title = "Relación entre Constructo Adicción a las Redes Sociales y Factores Antiestéticos y emocionales"
)
```
...
original_df <- mutate(original_df, autoestima = original_df$area_interperso + original_df$area_personal_corporal)
...
```{r}
original_df <- mutate(original_df, bsq = original_df$insatisfaccion_imagen_corp + original_df$preocupacion_peso_conductas_asociadas + original_df$factores_antiesteticos_emociones)
