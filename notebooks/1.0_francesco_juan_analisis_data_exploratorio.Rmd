...
mutate(original_df, factor_total_ars = original_df$fac1_ars + original_df$fac2_ars + original_df$fac3_ars)
```
...
#outliers de factores adiccion a las redes sociales
...
leveneTest(original_df$fac1_ars, original_df$trabajo_actual)

# Normalidad de VD: si p > 0.05 supuesto se cumple
shapiro.test(original_df$fac1_ars)
...
ggbetweenstats(
  ...
  title = "Factor 1 ARS Según Trabajo Actual" # Titulo con variables.
)
```
