...
model_lr <- lm(original_df$factor_total_ars ~ original_df$fac1_auto + original_df$fac2_auto + original_df$fac1_bsq + original_df$fac2_bsq + original_df$fac3_bsq, data = original_df)
