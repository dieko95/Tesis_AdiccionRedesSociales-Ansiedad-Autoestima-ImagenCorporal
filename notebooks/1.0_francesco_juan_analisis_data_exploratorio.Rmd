...
original_df <- mutate(original_df, factor_total_ars = original_df$obsesion_rrss + original_df$falta_de_control_rrss + original_df$uso_excesivo_rrss)
    ...
    #ADICCION A LAS REDES SOCIALES
      ...
      #ARS Factor Total
       original_df %>% 
        ...
        labs(x= "Encuestados", y= "Frecuencia de Factor Unificado ars", title = "Adicción Redes Sociales", subtitle = "Frecuencia del Factor Unificado") +
        geom_boxplot()
...
LeveneTest(original_df$factor_total_ars, original_df$municipio)
...
ggbetweenstats(
  ...
  title = "Factor Unificado ARS Según Municipio" # Titulo con variables.
)
...
# Igualdad de varianzas: si p > 0.05 supuesto se cumple
LeveneTest(original_df$factor_total_ars, original_df$sexo)
...
ggbetweenstats(
  ...
  title = "Factor Unificado ARS Según Sexo" # Titulo con variables.
)
...
# Igualdad de varianzas: si p > 0.05 supuesto se cumple
LeveneTest(original_df$factor_total_ars, original_df$edad)
...
ggbetweenstats(
  ...
  outlier.tagging  = TRUE,
  type = "parametric", # cambiar a "parametric" si supuestos se cumplen.
  title = "Factor Unificado ARS Según Edad" # Titulo con variables.
)
```
...
# Igualdad de varianzas: si p > 0.05 supuesto se cumple
LeveneTest(original_df$factor_total_ars, original_df$educación)
...
ggbetweenstats(
  ...
  outlier.tagging  = TRUE,
  type = "parametric", # cambiar a "parametric" si supuestos se cumplen.
  title = "Factor Unificado ARS Según Nivel Educativo" # Titulo con variables.
)
```
...
# Igualdad de varianzas: si p > 0.05 supuesto se cumple
LeveneTest(original_df$factor_total_ars, original_df$tipo_universidad)
...
ggbetweenstats(
  ...
  outlier.tagging  = TRUE,
  type = "parametric", # cambiar a "parametric" si supuestos se cumplen.
  title = "Factor Unificado ARS Según Tipo de Universiad" # Titulo con variables.
)
```
...
# Igualdad de varianzas: si p > 0.05 supuesto se cumple
LeveneTest(original_df$factor_total_ars, original_df$top1_rrss)
...
ggbetweenstats(
  ...
  outlier.tagging  = TRUE,
  type = "parametric", # cambiar a "parametric" si supuestos se cumplen.
  title = "Factor unificado de ARS Según top 1 de Redes Sociales" # Titulo con variables.
)
```
...
# Igualdad de varianzas: si p > 0.05 supuesto se cumple
LeveneTest(original_df$factor_total_ars, original_df$top2_rrss)
...
ggbetweenstats(
  ...
  outlier.tagging  = TRUE,
  type = "parametric", # cambiar a "parametric" si supuestos se cumplen.
  title = "Factor unificado de ARS Según top 2 de Redes Sociales" # Titulo con variables.
)
```
...
# Igualdad de varianzas: si p > 0.05 supuesto se cumple
LeveneTest(original_df$factor_total_ars, original_df$top3_rrss)
...
ggbetweenstats(
  ...
  outlier.tagging  = TRUE,
  type = "nonparametric", # cambiar a "parametric" si supuestos se cumplen.
  title = "Factor unificado de ARS Según top 3 de Redes Sociales" # Titulo con variables.
)
```
...
# Igualdad de varianzas: si p > 0.05 supuesto se cumple
LeveneTest(original_df$factor_total_ars, original_df$top4_rrss)
...
ggbetweenstats(
  ...
  outlier.tagging  = TRUE,
  type = "parametric", # cambiar a "parametric" si supuestos se cumplen.
  title = "Factor unificado de ARS Según top 4 de Redes Sociales" # Titulo con variables.
)
```
...
# Igualdad de varianzas: si p > 0.05 supuesto se cumple
LeveneTest(original_df$factor_total_ars, original_df$top5_rrss)
...
ggbetweenstats(
  ...
  outlier.tagging  = TRUE,
  type = "parametric", # cambiar a "parametric" si supuestos se cumplen.
  title = "Factor unificado de ARS Según top 5 de Redes Sociales" # Titulo con variables.
)
```
...
```{r}
# Igualdad de varianzas: si p > 0.05 supuesto se cumple
LeveneTest(original_df$factor_total_ars, original_df$area_interperso)
...
```{r}
# Igualdad de varianzas: si p > 0.05 supuesto se cumple
LeveneTest(original_df$factor_total_ars, original_df$area_personal_corporal)
